...
function generatePRMarkdown(summary, riskFlags, checklist, metadata) {
  ...
  lines.push('');
  lines.push(`> Analyzed by [PlanPlain](https://planplain.polsia.app) | ${metadata.resources_total} resource(s) changing`);
  lines.push('');
  lines.push('### Summary');
  lines.push('');
  lines.push(summary);
  ...
  lines.push('---');
  lines.push('*Generated by [PlanPlain](https://planplain.polsia.app)*');
  return lines.join('\n');
}
